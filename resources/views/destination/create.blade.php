...
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">New Destination</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="header-title mb-4">Add destination data</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required value="{{ old('area') }}" type="text" class="form-control"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input required value="{{ old('address') }}" type="text" class="form-control"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required value="{{ old('longitude') }}" type="text" class="form-control"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required value="{{ old('latitude') }}" type="text" class="form-control"
                        ...
                        <div class="col-md-12">
                            ...
                            <input value="{{ old('description') }}" type="hidden" name="description" id="description">
